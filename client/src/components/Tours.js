...
const Tours = ({tours}) => {
    ...
    const {loading, setTour} = tourContext;
    ...
    return (
        ...
        <Ul>
        {tours !== null && !loading ? (
           tours.map(({_id, name, section,text, img, cost,quantity,duration,included,unincluded,necessary,location,language,contentType,date}) =>(
                <Li key={_id}>
                <H3>{name}</H3>
                <ImageContainer>
                <Img src={img}/>
                ...
                <Div>
                    ...
                    <Link  to = {{
                        pathname:`/tours/${_id}`,
                        tourProps:{
                            _id, name, section,text, img, cost,quantity,duration,included,unincluded,necessary,location,language,contentType,date
                        }
